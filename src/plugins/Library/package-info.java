 ...
 */
/**
 ** Contains interfaces and the main Library class that holds them together. The index package and
 * its subpackages contain implementations of these interfaces.
 **
 ** @author MikeB
 ** @author infinity0
 */
