...
public interface IterableSerialiser<T> extends Archiver<T> {
  ...
  /**
   ** Execute everything in a group of {@link PullTask}s, returning only when they are all done.
   **
  ...
  /**
   ** Execute everything in a group of {@link PushTask}s, returning only when they are all done.
   **
   ** @param tasks The group of tasks to execute
   */
