...
public class ProgressTracker<T, P extends Progress> {
    ...
    protected P newProgress() {
        ...
        try {
            ...
            return null;    // constructor should prevent this from ever happening, but the
    ...
    public static <T, P extends Progress> Iterable<P> makePullProgressIterable(
        ...
        return new CompositeIterable<Map.Entry<PullTask<T>, ProgressTracker<T, ? extends P>>,
                                     P>(ids.entrySet(), true) {
            @Override
    ...
    public static <T, P extends Progress> Iterable<P> makePushProgressIterable(
        ...
        return new CompositeIterable<Map.Entry<PushTask<T>, ProgressTracker<T, ? extends P>>,
                                     P>(ids.entrySet(), true) {
            @Override
