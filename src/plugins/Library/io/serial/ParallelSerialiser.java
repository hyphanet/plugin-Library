...
public abstract class ParallelSerialiser<T, P extends Progress>
    ...
    protected Runnable createPullJob(final PullTask<T> task,
        ...
        try {
            final P prog = (post != null)
                           ? tracker.addPullProgress(task) : tracker.getPullProgress(task);
    ...
    protected Runnable createPushJob(final PushTask<T> task,
        ...
        try {
            final P prog = (post != null)
                           ? tracker.addPushProgress(task) : tracker.getPushProgress(task);
    ...
    */
    ...
    public <E> ObjectProcessor<PullTask<T>, E,
        ...
        return new ObjectProcessor<PullTask<T>, E, TaskAbortException>(input, output, deposit,
                                   null, Executors.DEFAULT_EXECUTOR,
                                   new TaskAbortExceptionConvertor()) {
            @Override
    ...
    */
    ...
    public <E> ObjectProcessor<PushTask<T>, E,
        ...
        return new ObjectProcessor<PushTask<T>, E, TaskAbortException>(input, output, deposit,
                                   null, Executors.DEFAULT_EXECUTOR,
                                   new TaskAbortExceptionConvertor()) {
            @Override
