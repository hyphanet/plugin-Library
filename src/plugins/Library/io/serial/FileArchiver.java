...
public class FileArchiver<T> implements Archiver<T>, LiveArchiver<T, SimpleProgress> {
        ...
        if (meta instanceof String) {
            ...
            if ((arr.length > 0) && (arr[0] instanceof String)) {
                ...
                throw new IllegalArgumentException(
                    "FileArchiver does not support such metadata: " +
                    java.util.Arrays.deepToString(arr));
            }
        } else if (meta != null) {
            throw new IllegalArgumentException("FileArchiver does not support such metadata: " +
                    meta);
        }
    ...
    public void pull(PullTask<T> t) throws TaskAbortException {
        ...
        try {
            ...
            try {
                FileLock lock = is.getChannel().lock(0L, Long.MAX_VALUE,
                                    true);  // shared lock for reading
