...
/**
 ** A {@link Sweeper} which only counts the number of objects added. It does not care about which
 * objects these are; it assumes the user handles this.
 **
 ** @author infinity0
 */
public class CountingSweeper<T> extends AbstractSweeper<T> {
   ...
   ** {@inheritDoc}
   **
   ** This implementation will always return true, since it does not keep track of the actual count
   * in the collection.
   */
  @Override
