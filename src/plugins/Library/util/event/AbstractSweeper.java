...
/**
 ** A partial implementation of {@link Sweeper}, defining some high-level methods in terms of lower
 * ones.
 **
...
abstract public class AbstractSweeper<T> implements Sweeper<T> {
  ...
  /**
   ** Add an object to the underlying collection. Implementations need not check for a valid state;
   * this is done by {@link #acquire(Object)}.
   **
  ...
  /**
   ** Remove an object from the underlying collection. Implementations need not check for a valid
   * state; this is done by {@link #release(Object)}.
   **
