...
final public class Maps {
  ...
  /**
   ** A {@link Entry} whose {@link Object#equals(Object)} and {@link Object#hashCode()} are defined
   * purely in terms of the key, which is immutable in the entry.
   **
   ** Note: technically this breaks the contract of {@link Entry}. Use only if you know what you're
   * doing.
   */
  public static class KeyEntry<K, V> extends BaseEntry<K, V> {
    ...
    /**
     ** Whether the object is also a {@link KeyEntry} and has the same {@code #key} as this entry.
     */
    @Override
    public boolean equals(Object o) {
  ...
  /*
   * final private static Map<String, String> testmap = of(SkeletonTreeMap.class, $("test1",
