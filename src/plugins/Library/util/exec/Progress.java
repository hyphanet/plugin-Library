...
public interface Progress {
  ...
  /**
   ** Get the details of this progress as a {@link ProgressParts} object, or throw an exception if
  ...
  /**
   ** Whether the progress has completed successfully, or throw an exception if it has aborted.
   */
  ...
  //
  // ...getName(): getStatus()
  // ...|________done|____________started|known|______________________estimate|
