...
public class BTreeSet<E> extends SortedMapSet<E, BTreeMap<E, E>>
  ...
  /**
   ** Creates a new empty set, sorted according to the given comparator, and with each non-root node
  ...
  /**
   ** Creates a new empty set, sorted according to the keys' {@link Comparable natural} ordering, and
  ...
  /**
   ** Protected constructor for use by the {@link SkeletonBTreeSet} constructors.
   */
