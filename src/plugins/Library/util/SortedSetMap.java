...
/**
 ** A {@link SortedMap} view of a {@link SortedSet}, with each key mapped to itself. The
 * {@link #put(Object, Object)} method only accepts both arguments if they are the same object.
 **
 ** Note: this class assumes the set's comparator is consistent with {@link Object#equals(Object)}.
 * FIXME LOW
 **
 ** @author infinity0
 */
    ...
    if (entries == null) {
      entries = new AbstractSet<Map.Entry<E, E>>() {
        ...
        public boolean remove(Object o) {
          ...
          if (c) {
            bkset.remove(((Map.Entry) o).getKey());
          }
          return c;
        }
