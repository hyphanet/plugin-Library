...
public class SkeletonBTreeSet<E>
    ...
    public void update(SortedSet<E> putset, SortedSet<E> remset) throws TaskAbortException {
        ((SkeletonBTreeMap<E, E>) bkmap).update(null, remset,
                new SortedSetMap<E, SortedSet<E>>(putset), null, new TaskAbortExceptionConvertor());
    }
     ...
     */
    public <Q, R> SkeletonBTreeMap<E, E>.NodeTranslator<Q, R> makeNodeTranslator(Translator<E,
            Q> ktr, Translator<SkeletonTreeMap<E, E>, R> mtr) {
     ...
     * @author infinity0
     */
    abstract public static class MapCollectionTranslator<E, M extends SkeletonTreeMap<E, E>,
            C extends Collection<E>> implements Translator<M, C> {
