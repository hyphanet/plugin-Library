...
abstract public class CompositeIterable<S, T> implements Iterable<T> {
  ...
  /**
   ** Create a new mutable iterable backed by the given iterable. Note that mutability will only have
   * an effect if the backing iterator is also mutable.
   */
  ...
  /**
   ** Create a new iterable backed by the given iterable, with the given mutability setting. Note
   * that mutability will only have an effect if the backing iterator is also mutable.
   */
  ...
  /* @Override **/ public Iterator<T> iterator() {
    return immutable ? new Iterator<T>() {
      ...
      /* @Override **/ public T next() {
        return CompositeIterable.this.nextFor(it.next());
      }
