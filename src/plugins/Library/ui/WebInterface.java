...
public class WebInterface {
  ...
  public void load() {
    ...
    // allowed, this is a temporary Toadlet untilthere is a whitelist for formfilter and /library is
    // on it TODO put /library on formfilter whitelist
    pluginsToadlet = new MainPageToadlet(client, library, core, pr);
    toadletContainer.register(pluginsToadlet, null, "/plugins/plugin.Library.FreesiteSearch", true,
        null, null, true, null);
