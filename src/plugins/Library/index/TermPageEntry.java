...
public class TermPageEntry extends TermEntry {
  ...
  /**
   * Positions where the term occurs. May be null if we don't have that data. Specified as
   * SortedSet<Integer> for ObjectBlueprint but will really always be a SortedIntSet.
   */
   ...
   ** For serialisation.
   */
  public TermPageEntry(String s, float r, FreenetURI u, String t, Set<Integer> pos,
