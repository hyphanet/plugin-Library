...
public class MainIndexParser extends DefaultHandler {
    ...
    protected class V1Handler extends DefaultHandler {
        ...
        private void mainStartElement(String uri, String localName, String qName,
        ...
        private void headerStartElement(String uri, String localName, String qName,
                Attributes attributes) {
            headerKey = localName;
        ...
        private void headerInnerStartElement(String uri, String localName, String qName,
                Attributes attributes)
                throws SAXException {
            throw new SAXException("Bad tag <" + localName + "> in header @" + location());
        }

        private void keywordsStartElement(String uri, String localName, String qName,
                Attributes attributes)
                throws SAXException {
            ...
            if ((key == null) || (key.length() < 1) || (key.length() > 32) ||
        ...
        private void mainEndElement(String uri, String localName, String qName)
                throws SAXException {
        ...
        private void headerEndElement(String uri, String localName, String qName)
                throws SAXException {
            if ( !"header".equals(localName)) {
                throw new SAXException("Bad close tag </" + localName + "> in header @" +
                                       location());
            }
        ...
        private void headerInnerEndElement(String uri, String localName, String qName)
                throws SAXException {
        ...
        private void keywordsEndElement(String uri, String localName, String qName)
                throws SAXException {
            if ("subIndex".equals(localName)) {
                ...
                throw new SAXException("Bad close tag </" + localName + "> in keywords @" +
                                       location());
            }
        }
    }
    ...
    private int detectVersion(String uri, String localName, String qName, Attributes attributes)
            throws SAXException {
        if ("main_index".equals(localName)) {
            return 1;
        } else {
