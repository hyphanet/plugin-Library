...
public class TermResults {
  ...
  /**
   ** Map of parent terms to the relevances that were seen for this term in the results for the
   * parent.
   */
  /* final */ public Map<String, Collection<Float>> parents;

  /**
   ** Incremental calculation of effective relevance. May not be exact if if additional indexes were
   * encountered referencing this term, after the last update to this field.
   */
  protected float av_pcv_rel_;

  /**
   ** Get the cached effective relevance. Use this in preference to
   * {@link Interdex#getEffectiveRelevance()} when the search is still ongoing.
   **
   ** TODO this should be a good estimate that is always greater than the actual value...
   */
